...
#if (defined(__APPLE__) && defined(__MACH__)) || defined(__linux__) || defined(__OpenBSD__) || defined(__wasi__)
...
void Lib_Memzero0_memzero0(void *dst, uint64_t len) {
  ...
  #elif (defined(__linux__) && !defined(LINUX_NO_EXPLICIT_BZERO)) || defined(__FreeBSD__) || defined(__OpenBSD__) || defined(__wasi__)
